...
(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get("https://rawgit.com/Upcoming-Records/basicBot/master/lang/langIndex.json", function (json) {
            ...
            helpCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        var link = "http://tinyurl.com/upcomingrecords-playlists";
			...
			songstatslinkCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(basicBot.chat.songstatslink)
                    }
                }
            },
			...
			stafftipsCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(basicBot.chat.stafftips)
                    }
                }
            },
            ...
            aboutslackCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(basicBot.chat.aboutslack)
                    }
                }
            },
            ...
            highfiveCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        var space = msg.indexOf(' ');
                        if (space === -1) {
                            API.sendChat(basicBot.chat.highfivehelp);
                            return false;
                        }
                        else {
                            var name = msg.substring(space + 2);
            ...
            hugCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        var space = msg.indexOf(' ');
                        if (space === -1) {
                            API.sendChat(basicBot.chat.hughelp);
                            return false;
                        }
                        else {
                            var name = msg.substring(space + 2);
